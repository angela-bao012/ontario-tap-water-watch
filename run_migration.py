#!/usr/bin/env python3
"""
Hardcoded migration script for migrating Ontario drinking water quality Excel files into PostgreSQL
using the direct connection string: postgresql://postgres:68391975@localhost:5432/water_watch.
...
if __name__ == '__main__':
    print("=" * 60)
    print("Migrating Ontario Water Data to PostgreSQL (Direct & Raw)")
    print("=" * 60)
    migrate_data()
